...
/* get css */
    function include_css_files() {
        wp_enqueue_style('google-fonts', "https://fonts.googleapis.com/css2?family=Sarabun&display=swap");
 ...
 /* get js */   
    function include_js_files() {
        wp_enqueue_script('idm250-js', get_template_directory_uri() . '/assets/scripts.js');
    }
