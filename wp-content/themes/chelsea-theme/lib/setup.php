...
function include_css_files() {
    ...
    wp_enqueue_style('idm250-css', '/wp-content/themes/chelsea-theme/assets/style.css');
...
function include_js_files() {
    wp_enqueue_script('idm250-js', '/wp-content/themes/chelsea-theme/assets/scripts.js', [], false, true);
}
